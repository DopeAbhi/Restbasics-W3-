        ...
        for (int i = 0; i < sheets; i++) {
            ...
            if (workbook.getSheetName(i).equalsIgnoreCase("UserTree")) {
                ...
                while (rows.hasNext()) {
                 ...
                 Row row2= sheet2.createRow( sheet2.getLastRowNum());
                    ...
                    if (T) {
                        ...
                        if (status) {
                            ...
                            userdata[0] = loginjson.getString("data.firstName");
                            userdata[1] = loginjson.getString("data.lastName");
                            userdata[2] = loginjson.getString("data.userName");
                            userdata[3]=loginjson.getString("data.email");
                           ...
                           userdata[6]=loginjson.getString("data.imageUrl");
                            ...
                            userdata[0] = avatarjson.getString("data.firstName");
                            userdata[1] = avatarjson.getString("data.lastName");
                            userdata[2] = avatarjson.getString("data.userName");
                            userdata[3]=avatarjson.getString("data.email");
                            ...
                            userdata[9]=avatarjson.getString("data.token");
                        ...
                        referralLink = rawreferral.substring((rawreferral.length()) - 10, rawreferral.length());
                        System.out.println(referralLink);
                        userdata[0] = treeavatarjson.getString("data.firstName");
                        userdata[1] = treeavatarjson.getString("data.lastName");
                        userdata[2] = treeavatarjson.getString("data.userName");
                        userdata[3]=treeavatarjson.getString("data.email");
                        ...
                        userdata[9]=treeavatarjson.getString("data.token");
